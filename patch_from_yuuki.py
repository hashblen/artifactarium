...
Repo.clone_from(
    "https://github.com/hashblen/artifactarium-codegen.git", "artifactarium-codegen"
)
...
os.system("cd artifactarium-codegen && cargo run -- ../. ../data")
...
shutil.rmtree("artifactarium-codegen", onexc=remove_readonly)
