...
pub struct SceneAvatarInfo {
    ...
    pub anim_hash: u32,
    // @@protoc_insertion_point(field:SceneAvatarInfo.trace_effect_id)
...
impl SceneAvatarInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "trace_effect_id",
            |m: &SceneAvatarInfo| { &m.trace_effect_id },
            |m: &mut SceneAvatarInfo| { &mut m.trace_effect_id },
        ));
...
impl ::protobuf::Message for SceneAvatarInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                184 => {
                    self.trace_effect_id = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.equip_id_list);
        if self.skill_depot_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.skill_depot_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.talent_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.inherent_proud_skill_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(16, &self.team_resonance_list);
        ...
        if self.trace_effect_id != 0 {
            my_size += ::protobuf::rt::uint32_size(23, self.trace_effect_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(5, &self.equip_id_list)?;
        if self.skill_depot_id != 0 {
            os.write_uint32(6, self.skill_depot_id)?;
        }
        os.write_repeated_packed_uint32(7, &self.talent_id_list)?;
        if let Some(v) = self.weapon.as_ref() {
        ...
        os.write_repeated_packed_uint32(12, &self.inherent_proud_skill_list)?;
        for (k, v) in &self.skill_level_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
            entry_size += ::protobuf::rt::uint32_size(2, *v);
        ...
        os.write_repeated_packed_uint32(16, &self.team_resonance_list)?;
        if self.wearing_flycloak_id != 0 {
        ...
        if self.trace_effect_id != 0 {
            os.write_uint32(23, self.trace_effect_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x15AvatarExcelInfo.proto\"\xff\x08\n\x0fSceneAvatarInfo\x12\x10\n\x03ui\
    ...
    \x01(\rR\x08animHash\x12&\n\x0ftrace_effect_id\x18\x17\x20\x01(\rR\rtrac\
