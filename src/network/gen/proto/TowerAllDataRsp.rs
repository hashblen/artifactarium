...
impl ::protobuf::Message for TowerAllDataRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.tower_schedule_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.tower_schedule_id);
        }
        if self.is_finished_entrance_floor != false {
            my_size += 1 + 1;
        }
        if self.valid_floor_record_list != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.valid_floor_record_list);
        }
        ...
        if self.next_schedule_change_time != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.next_schedule_change_time);
        }
        ...
        if self.schedule_start_time != 0 {
            my_size += ::protobuf::rt::uint32_size(1082, self.schedule_start_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.tower_schedule_id != 0 {
            os.write_uint32(4, self.tower_schedule_id)?;
        }
        if self.is_finished_entrance_floor != false {
            os.write_bool(10, self.is_finished_entrance_floor)?;
        }
        if self.valid_floor_record_list != 0 {
            os.write_uint32(6, self.valid_floor_record_list)?;
        }
        if let Some(v) = self.cur_level_record.as_ref() {
        ...
        if self.next_schedule_change_time != 0 {
            os.write_uint32(3, self.next_schedule_change_time)?;
        }
        if let Some(v) = self.monthly_brief.as_ref() {
        ...
        if self.schedule_start_time != 0 {
            os.write_uint32(1082, self.schedule_start_time)?;
        }
        if let Some(v) = self.last_schedule_monthly_brief.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    rFloorRecord.proto\x1a\x17TowerMonthlyBrief.proto\"\xe8\x07\n\x0fTowerAl\
    lDataRsp\x12*\n\x11tower_schedule_id\x18\x04\x20\x01(\rR\x0ftowerSchedul\
    eId\x12;\n\x1ais_finished_entrance_floor\x18\n\x20\x01(\x08R\x17isFinish\
    edEntranceFloor\x125\n\x17valid_floor_record_list\x18\x06\x20\x01(\rR\
    \x14validFloorRecordList\x12>\n\x10cur_level_record\x18\x01\x20\x01(\x0b\
    2\x14.TowerCurLevelRecordR\x0ecurLevelRecord\x12\x18\n\x07retcode\x18\
    \x0b\x20\x01(\x05R\x07retcode\x12~\n\"skip_floor_granted_reward_item_map\
    \x18\x0e\x20\x03(\x0b23.TowerAllDataRsp.SkipFloorGrantedRewardItemMapEnt\
    ryR\x1dskipFloorGrantedRewardItemMap\x12*\n\x11is_first_interact\x18\x07\
    \x20\x01(\x08R\x0fisFirstInteract\x12U\n\x13floor_open_time_map\x18\x0f\
    \x20\x03(\x0b2&.TowerAllDataRsp.FloorOpenTimeMapEntryR\x10floorOpenTimeM\
    ap\x129\n\x19next_schedule_change_time\x18\x03\x20\x01(\rR\x16nextSchedu\
    leChangeTime\x127\n\rmonthly_brief\x18\x08\x20\x01(\x0b2\x12.TowerMonthl\
    yBriefR\x0cmonthlyBrief\x12H\n\x17tower_floor_record_list\x18\x05\x20\
    \x03(\x0b2\x11.TowerFloorRecordR\x14towerFloorRecordList\x12/\n\x13sched\
    ule_start_time\x18\xba\x08\x20\x01(\rR\x11scheduleStartTime\x12R\n\x1bla\
    st_schedule_monthly_brief\x18\x90\x08\x20\x01(\x0b2\x12.TowerMonthlyBrie\
    fR\x18lastScheduleMonthlyBrief\x1aP\n\"SkipFloorGrantedRewardItemMapEntr\
    y\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\x12\x14\n\x05value\x18\x02\
    \x20\x01(\rR\x05value:\x028\x01\x1aC\n\x15FloorOpenTimeMapEntry\x12\x10\
