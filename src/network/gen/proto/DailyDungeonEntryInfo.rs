...
pub struct DailyDungeonEntryInfo {
    ...
    // @@protoc_insertion_point(field:DailyDungeonEntryInfo.next_refresh_time)
...
impl DailyDungeonEntryInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "next_refresh_time",
            |m: &DailyDungeonEntryInfo| { &m.next_refresh_time },
            |m: &mut DailyDungeonEntryInfo| { &mut m.next_refresh_time },
        ));
...
impl ::protobuf::Message for DailyDungeonEntryInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.dungeon_entry_config_id != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.dungeon_entry_config_id);
        }
        if self.dungeon_entry_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.dungeon_entry_id);
        }
        if self.recommend_dungeon_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.recommend_dungeon_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.dungeon_entry_config_id != 0 {
            os.write_uint32(9, self.dungeon_entry_config_id)?;
        }
        if self.dungeon_entry_id != 0 {
            os.write_uint32(11, self.dungeon_entry_id)?;
        }
        if self.recommend_dungeon_id != 0 {
            os.write_uint32(14, self.recommend_dungeon_id)?;
        }
        if self.next_refresh_time != 0 {
            os.write_fixed32(15, self.next_refresh_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bDailyDungeonEntryInfo.proto\"\xd6\x01\n\x15DailyDungeonEntryInfo\
    \x125\n\x17dungeon_entry_config_id\x18\t\x20\x01(\rR\x14dungeonEntryConf\
    igId\x12(\n\x10dungeon_entry_id\x18\x0b\x20\x01(\rR\x0edungeonEntryId\
    \x120\n\x14recommend_dungeon_id\x18\x0e\x20\x01(\rR\x12recommendDungeonI\
    d\x12*\n\x11next_refresh_time\x18\x0f\x20\x01(\x07R\x0fnextRefreshTimeB\
