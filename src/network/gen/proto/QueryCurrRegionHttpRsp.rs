...
pub struct QueryCurrRegionHttpRsp {
    ...
    // @@protoc_insertion_point(field:QueryCurrRegionHttpRsp.gate_ticket)
...
impl QueryCurrRegionHttpRsp {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "gate_ticket",
            |m: &QueryCurrRegionHttpRsp| { &m.gate_ticket },
            |m: &mut QueryCurrRegionHttpRsp| { &mut m.gate_ticket },
        ));
...
impl ::protobuf::Message for QueryCurrRegionHttpRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.gate_ticket.is_empty() {
            my_size += ::protobuf::rt::string_size(14, &self.gate_ticket);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.gate_ticket.is_empty() {
            os.write_string(14, &self.gate_ticket)?;
        }
        if let ::std::option::Option::Some(ref v) = self.detail {
            match v {
                &query_curr_region_http_rsp::Detail::ForceUpdate(ref v) => {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    pdateInfo.proto\x1a\x14StopServerInfo.proto\"\xcb\x03\n\x16QueryCurrRegi\
    ...
    \x0b\x20\x01(\x0cR\x0fclientSecretKey\x12C\n\x1eregion_custom_config_enc\
    rypted\x18\x0c\x20\x01(\x0cR\x1bregionCustomConfigEncrypted\x12P\n%clien\
    t_region_custom_config_encrypted\x18\r\x20\x01(\x0cR!clientRegionCustomC\
    onfigEncrypted\x12\x1f\n\x0bgate_ticket\x18\x0e\x20\x01(\tR\ngateTicket\
    \x125\n\x0cforce_update\x18\x04\x20\x01(\x0b2\x10.ForceUpdateInfoH\0R\
    \x0bforceUpdate\x122\n\x0bstop_server\x18\x05\x20\x01(\x0b2\x0f.StopServ\
