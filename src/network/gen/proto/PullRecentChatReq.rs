...
impl ::protobuf::Message for PullRecentChatReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.begin_sequence != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.begin_sequence);
        }
        if self.pull_num != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.pull_num);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.begin_sequence != 0 {
            os.write_uint32(15, self.begin_sequence)?;
        }
        if self.pull_num != 0 {
            os.write_uint32(14, self.pull_num)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17PullRecentChatReq.proto\"U\n\x11PullRecentChatReq\x12%\n\x0ebegin_\
    sequence\x18\x0f\x20\x01(\rR\rbeginSequence\x12\x19\n\x08pull_num\x18\
    \x0e\x20\x01(\rR\x07pullNumB\x1b\n\x19emu.grasscutter.net.protob\x06prot\
    o3\
";
