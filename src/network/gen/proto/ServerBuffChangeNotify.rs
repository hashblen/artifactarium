...
impl ::protobuf::Message for ServerBuffChangeNotify {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.entity_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint64_size(11, &self.avatar_guid_list);
        if self.server_buff_change_type != ::protobuf::EnumOrUnknown::new(server_buff_change_notify::ServerBuffChangeType::SERVER_BUFF_CHANGE_TYPE_ADD_SERVER_BUFF) {
            my_size += ::protobuf::rt::int32_size(14, self.server_buff_change_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(1, &self.entity_id_list)?;
        for v in &self.server_buff_list {
            ::protobuf::rt::write_message_field_with_cached_size(2, v, os)?;
        };
        if self.is_creature_buff != false {
            os.write_bool(3, self.is_creature_buff)?;
        }
        os.write_repeated_packed_uint64(11, &self.avatar_guid_list)?;
        if self.server_buff_change_type != ::protobuf::EnumOrUnknown::new(server_buff_change_notify::ServerBuffChangeType::SERVER_BUFF_CHANGE_TYPE_ADD_SERVER_BUFF) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.server_buff_change_type))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x16ServerBuffChangeNotify\x12$\n\x0eentity_id_list\x18\x01\x20\x03(\rR\
    \x0centityIdList\x125\n\x10server_buff_list\x18\x02\x20\x03(\x0b2\x0b.Se\
    rverBuffR\x0eserverBuffList\x12(\n\x10is_creature_buff\x18\x03\x20\x01(\
    \x08R\x0eisCreatureBuff\x12(\n\x10avatar_guid_list\x18\x0b\x20\x03(\x04R\
    \x0eavatarGuidList\x12c\n\x17server_buff_change_type\x18\x0e\x20\x01(\
    \x0e2,.ServerBuffChangeNotify.ServerBuffChangeTypeR\x14serverBuffChangeT\
    ype\"p\n\x14ServerBuffChangeType\x12+\n'SERVER_BUFF_CHANGE_TYPE_ADD_SERV\
    ER_BUFF\x10\0\x12+\n'SERVER_BUFF_CHANGE_TYPE_DEL_SERVER_BUFF\x10\x01B\
