...
impl ::protobuf::Message for AvatarRenameInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if !self.avatar_name.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.avatar_name);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if !self.avatar_name.is_empty() {
            os.write_string(15, &self.avatar_name)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16AvatarRenameInfo.proto\"P\n\x10AvatarRenameInfo\x12\x1b\n\tavatar_\
    id\x18\r\x20\x01(\rR\x08avatarId\x12\x1f\n\x0bavatar_name\x18\x0f\x20\
