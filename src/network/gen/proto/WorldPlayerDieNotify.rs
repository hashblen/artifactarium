...
pub struct WorldPlayerDieNotify {
    // message fields
    // @@protoc_insertion_point(field:WorldPlayerDieNotify.GOEACHAMIAF)
    pub GOEACHAMIAF: ::protobuf::MessageField<super::AbilityString::AbilityString>,
    // @@protoc_insertion_point(field:WorldPlayerDieNotify.murderer_entity_id)
    pub murderer_entity_id: u32,
    // @@protoc_insertion_point(field:WorldPlayerDieNotify.GKHNLKAADNG)
    pub GKHNLKAADNG: u32,
...
impl WorldPlayerDieNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_message_field_accessor::<_, super::AbilityString::AbilityString>(
            "GOEACHAMIAF",
            |m: &WorldPlayerDieNotify| { &m.GOEACHAMIAF },
            |m: &mut WorldPlayerDieNotify| { &mut m.GOEACHAMIAF },
        ));
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GKHNLKAADNG",
            |m: &WorldPlayerDieNotify| { &m.GKHNLKAADNG },
            |m: &mut WorldPlayerDieNotify| { &mut m.GKHNLKAADNG },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "die_type",
...
impl ::protobuf::Message for WorldPlayerDieNotify {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                10 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.GOEACHAMIAF)?;
                },
                40 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if let Some(v) = self.GOEACHAMIAF.as_ref() {
            let len = v.compute_size();
            my_size += 1 + ::protobuf::rt::compute_raw_varint64_size(len) + len;
        }
        if self.murderer_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.murderer_entity_id);
        }
        if self.GKHNLKAADNG != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.GKHNLKAADNG);
        }
        if self.die_type != ::protobuf::EnumOrUnknown::new(super::PlayerDieType::PlayerDieType::PLAYER_DIE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(15, self.die_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.murderer_entity_id != 0 {
            os.write_uint32(5, self.murderer_entity_id)?;
        }
        if self.GKHNLKAADNG != 0 {
            os.write_uint32(7, self.GKHNLKAADNG)?;
        }
        if self.die_type != ::protobuf::EnumOrUnknown::new(super::PlayerDieType::PlayerDieType::PLAYER_DIE_TYPE_NONE) {
            os.write_enum(15, ::protobuf::EnumOrUnknown::value(&self.die_type))?;
        }
        if let ::std::option::Option::Some(ref v) = self.entity {
            match v {
                &world_player_die_notify::Entity::GadgetId(v) => {
    ...
    fn default_instance() -> &'static WorldPlayerDieNotify {
        static instance: WorldPlayerDieNotify = WorldPlayerDieNotify {
            GOEACHAMIAF: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1aWorldPlayerDieNotify.proto\x1a\x13AbilityString.proto\x1a\x13Playe\
    rDieType.proto\"\x8d\x02\n\x14WorldPlayerDieNotify\x120\n\x0bGOEACHAMIAF\
    \x18\x01\x20\x01(\x0b2\x0e.AbilityStringR\x0bGOEACHAMIAF\x12,\n\x12murde\
    rer_entity_id\x18\x05\x20\x01(\rR\x10murdererEntityId\x12\x20\n\x0bGKHNL\
    KAADNG\x18\x07\x20\x01(\rR\x0bGKHNLKAADNG\x12)\n\x08die_type\x18\x0f\x20\
    \x01(\x0e2\x0e.PlayerDieTypeR\x07dieType\x12\x1d\n\tgadget_id\x18\x03\
    \x20\x01(\rH\0R\x08gadgetId\x12\x1f\n\nmonster_id\x18\x0b\x20\x01(\rH\0R\
