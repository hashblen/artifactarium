...
impl ::protobuf::Message for CoopChapter {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(9, &self.LAAOIEBFJKP);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.EOMGDNCEACF);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(9, &self.LAAOIEBFJKP)?;
        for (k, v) in &self.seen_ending_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
            entry_size += ::protobuf::rt::uint32_size(2, *v);
        ...
        os.write_repeated_packed_uint32(7, &self.EOMGDNCEACF)?;
        if self.HKOAKJNBIIO != 0 {
