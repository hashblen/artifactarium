...
pub struct Shop {
    ...
    // @@protoc_insertion_point(field:Shop.DGEAKOFNGDN)
    pub DGEAKOFNGDN: u32,
...
impl Shop {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DGEAKOFNGDN",
            |m: &Shop| { &m.DGEAKOFNGDN },
            |m: &mut Shop| { &mut m.DGEAKOFNGDN },
        ));
...
impl ::protobuf::Message for Shop {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                40 => {
                    self.DGEAKOFNGDN = is.read_uint32()?;
                },
                58 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.city_reputation_level != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.city_reputation_level);
        }
        if self.shop_type != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.shop_type);
        }
        if self.next_refresh_time != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.next_refresh_time);
        }
        if self.DGEAKOFNGDN != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.DGEAKOFNGDN);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.city_reputation_level != 0 {
            os.write_uint32(2, self.city_reputation_level)?;
        }
        if self.shop_type != 0 {
            os.write_uint32(3, self.shop_type)?;
        }
        if self.next_refresh_time != 0 {
            os.write_uint32(4, self.next_refresh_time)?;
        }
        if self.DGEAKOFNGDN != 0 {
            os.write_uint32(5, self.DGEAKOFNGDN)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\nShop.proto\x1a\x16ShopMcoinProduct.proto\x1a\x15ShopCardProduct.prot\
    o\x1a\x0fShopGoods.proto\x1a\x18ShopConcertProduct.proto\"\xaf\x03\n\x04\
    Shop\x122\n\x15city_reputation_level\x18\x02\x20\x01(\rR\x13cityReputati\
    onLevel\x12\x1b\n\tshop_type\x18\x03\x20\x01(\rR\x08shopType\x12*\n\x11n\
    ext_refresh_time\x18\x04\x20\x01(\rR\x0fnextRefreshTime\x12\x20\n\x0bDGE\
    AKOFNGDN\x18\x05\x20\x01(\rR\x0bDGEAKOFNGDN\x12?\n\x12mcoin_product_list\
    \x18\x07\x20\x03(\x0b2\x11.ShopMcoinProductR\x10mcoinProductList\x12<\n\
    \x11card_product_list\x18\t\x20\x03(\x0b2\x10.ShopCardProductR\x0fcardPr\
    oductList\x12)\n\ngoods_list\x18\n\x20\x03(\x0b2\n.ShopGoodsR\tgoodsList\
    \x12E\n\x14concert_product_list\x18\x0c\x20\x03(\x0b2\x13.ShopConcertPro\
    ductR\x12concertProductList\x12\x17\n\x07city_id\x18\x0e\x20\x01(\rR\x06\
