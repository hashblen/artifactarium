...
pub enum PlayerDieType {
    ...
    // @@protoc_insertion_point(enum_value:PlayerDieType.PLAYER_DIE_TYPE_LIQUID_PHLOGISTON)
...
impl ::protobuf::Enum for PlayerDieType {
    ...
    fn from_i32(value: i32) -> ::std::option::Option<PlayerDieType> {
        match value {
            ...
            10 => ::std::option::Option::Some(PlayerDieType::PLAYER_DIE_TYPE_LIQUID_PHLOGISTON),
    ...
    fn from_str(str: &str) -> ::std::option::Option<PlayerDieType> {
        match str {
            ...
            "PLAYER_DIE_TYPE_LIQUID_PHLOGISTON" => ::std::option::Option::Some(PlayerDieType::PLAYER_DIE_TYPE_LIQUID_PHLOGISTON),
            _ => ::std::option::Option::None
        }
    }
    ...
    const VALUES: &'static [PlayerDieType] = &[
        ...
        PlayerDieType::PLAYER_DIE_TYPE_LIQUID_PHLOGISTON,
    ];
}
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x13PlayerDieType.proto*\xee\x02\n\rPlayerDieType\x12\x18\n\x14PLAYER_\
