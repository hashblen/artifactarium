...
pub struct SocialDetail {
    ...
    // @@protoc_insertion_point(field:SocialDetail.CMOBLNACDIE)
    pub CMOBLNACDIE: u32,
    // @@protoc_insertion_point(field:SocialDetail.GEGBOECJJMO)
    pub GEGBOECJJMO: u32,
    // @@protoc_insertion_point(field:SocialDetail.MBOLLDBJPCP)
    pub MBOLLDBJPCP: u32,
    // @@protoc_insertion_point(field:SocialDetail.is_show_constellation_num)
    pub is_show_constellation_num: bool,
    // @@protoc_insertion_point(field:SocialDetail.FLMFEMCAFHB)
    pub FLMFEMCAFHB: u32,
    // @@protoc_insertion_point(field:SocialDetail.MOBMAJIJJGL)
    pub MOBMAJIJJGL: u32,
    // special fields
...
impl SocialDetail {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CMOBLNACDIE",
            |m: &SocialDetail| { &m.CMOBLNACDIE },
            |m: &mut SocialDetail| { &mut m.CMOBLNACDIE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GEGBOECJJMO",
            |m: &SocialDetail| { &m.GEGBOECJJMO },
            |m: &mut SocialDetail| { &mut m.GEGBOECJJMO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MBOLLDBJPCP",
            |m: &SocialDetail| { &m.MBOLLDBJPCP },
            |m: &mut SocialDetail| { &mut m.MBOLLDBJPCP },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "is_show_constellation_num",
            |m: &SocialDetail| { &m.is_show_constellation_num },
            |m: &mut SocialDetail| { &mut m.is_show_constellation_num },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "FLMFEMCAFHB",
            |m: &SocialDetail| { &m.FLMFEMCAFHB },
            |m: &mut SocialDetail| { &mut m.FLMFEMCAFHB },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "MOBMAJIJJGL",
            |m: &SocialDetail| { &m.MOBMAJIJJGL },
            |m: &mut SocialDetail| { &mut m.MOBMAJIJJGL },
        ));
...
impl ::protobuf::Message for SocialDetail {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                216 => {
                    self.CMOBLNACDIE = is.read_uint32()?;
                },
                224 => {
                    self.GEGBOECJJMO = is.read_uint32()?;
                },
                256 => {
                    self.MBOLLDBJPCP = is.read_uint32()?;
                },
                264 => {
                    self.is_show_constellation_num = is.read_bool()?;
                },
                272 => {
                    self.FLMFEMCAFHB = is.read_uint32()?;
                },
                280 => {
                    self.MOBMAJIJJGL = is.read_uint32()?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.reserved_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(23, &self.show_name_card_id_list);
        ...
        if self.CMOBLNACDIE != 0 {
            my_size += ::protobuf::rt::uint32_size(27, self.CMOBLNACDIE);
        }
        if self.GEGBOECJJMO != 0 {
            my_size += ::protobuf::rt::uint32_size(28, self.GEGBOECJJMO);
        }
        if self.MBOLLDBJPCP != 0 {
            my_size += ::protobuf::rt::uint32_size(32, self.MBOLLDBJPCP);
        }
        if self.is_show_constellation_num != false {
            my_size += 2 + 1;
        }
        if self.FLMFEMCAFHB != 0 {
            my_size += ::protobuf::rt::uint32_size(34, self.FLMFEMCAFHB);
        }
        if self.MOBMAJIJJGL != 0 {
            my_size += ::protobuf::rt::uint32_size(35, self.MOBMAJIJJGL);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(8, &self.reserved_list)?;
        if self.online_state != ::protobuf::EnumOrUnknown::new(super::FriendOnlineState::FriendOnlineState::FRIEND_ONLINE_STATE_DISCONNECT) {
        ...
        os.write_repeated_packed_uint32(23, &self.show_name_card_id_list)?;
        if self.friend_enter_home_option != ::protobuf::EnumOrUnknown::new(super::FriendEnterHomeOption::FriendEnterHomeOption::FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM) {
        ...
        if self.CMOBLNACDIE != 0 {
            os.write_uint32(27, self.CMOBLNACDIE)?;
        }
        if self.GEGBOECJJMO != 0 {
            os.write_uint32(28, self.GEGBOECJJMO)?;
        }
        if self.MBOLLDBJPCP != 0 {
            os.write_uint32(32, self.MBOLLDBJPCP)?;
        }
        if self.is_show_constellation_num != false {
            os.write_bool(33, self.is_show_constellation_num)?;
        }
        if self.FLMFEMCAFHB != 0 {
            os.write_uint32(34, self.FLMFEMCAFHB)?;
        }
        if self.MOBMAJIJJGL != 0 {
            os.write_uint32(35, self.MOBMAJIJJGL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    to\x1a\x14ProfilePicture.proto\"\x85\n\n\x0cSocialDetail\x12\x10\n\x03ui\
    d\x18\x01\x20\x01(\rR\x03uid\x12\x1a\n\x08nickname\x18\x02\x20\x01(\tR\
    ...
    _code\x18\x1a\x20\x01(\tR\x06ipCode\x12\x20\n\x0bCMOBLNACDIE\x18\x1b\x20\
    \x01(\rR\x0bCMOBLNACDIE\x12\x20\n\x0bGEGBOECJJMO\x18\x1c\x20\x01(\rR\x0b\
    GEGBOECJJMO\x12\x20\n\x0bMBOLLDBJPCP\x18\x20\x20\x01(\rR\x0bMBOLLDBJPCP\
    \x129\n\x19is_show_constellation_num\x18!\x20\x01(\x08R\x16isShowConstel\
    lationNum\x12\x20\n\x0bFLMFEMCAFHB\x18\"\x20\x01(\rR\x0bFLMFEMCAFHB\x12\
    \x20\n\x0bMOBMAJIJJGL\x18#\x20\x01(\rR\x0bMOBMAJIJJGLB\x1b\n\x19emu.gras\
