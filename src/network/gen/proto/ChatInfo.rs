...
impl ChatInfo {
    ...
    // .ChatInfo.SystemHint system_hint = 922;
...
impl ::protobuf::Message for ChatInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.sequence != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.sequence);
        }
        if self.uid != 0 {
        ...
        if let ::std::option::Option::Some(ref v) = self.content {
            match v {
                ...
                &chat_info::Content::Text(ref v) => {
                    my_size += ::protobuf::rt::string_size(357, &v);
                },
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.sequence != 0 {
            os.write_uint32(7, self.sequence)?;
        }
        if self.uid != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x0eChatInfo.proto\"\x90\x03\n\x08ChatInfo\x12\x17\n\x07is_read\x18\
    \x04\x20\x01(\x08R\x06isRead\x12\x12\n\x04time\x18\x08\x20\x01(\rR\x04ti\
    me\x12\x15\n\x06to_uid\x18\x05\x20\x01(\rR\x05toUid\x12\x1a\n\x08sequenc\
    e\x18\x07\x20\x01(\rR\x08sequence\x12\x10\n\x03uid\x18\n\x20\x01(\rR\x03\
    uid\x12\x14\n\x04icon\x18\x15\x20\x01(\rH\0R\x04icon\x12\x15\n\x04text\
    \x18\xe5\x02\x20\x01(\tH\0R\x04text\x128\n\x0bsystem_hint\x18\x9a\x07\
