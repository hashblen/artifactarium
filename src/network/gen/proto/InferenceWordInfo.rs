...
pub struct InferenceWordInfo {
    // message fields
    // @@protoc_insertion_point(field:InferenceWordInfo.DHBPEBDBMNK)
    pub DHBPEBDBMNK: bool,
    // @@protoc_insertion_point(field:InferenceWordInfo.CAJHCPIPBOO)
    pub CAJHCPIPBOO: bool,
    ...
    // @@protoc_insertion_point(field:InferenceWordInfo.ENFPKOPNHKK)
    pub ENFPKOPNHKK: bool,
    // special fields
...
impl InferenceWordInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "DHBPEBDBMNK",
            |m: &InferenceWordInfo| { &m.DHBPEBDBMNK },
            |m: &mut InferenceWordInfo| { &mut m.DHBPEBDBMNK },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CAJHCPIPBOO",
            |m: &InferenceWordInfo| { &m.CAJHCPIPBOO },
            |m: &mut InferenceWordInfo| { &mut m.CAJHCPIPBOO },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "word_id",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "ENFPKOPNHKK",
            |m: &InferenceWordInfo| { &m.ENFPKOPNHKK },
            |m: &mut InferenceWordInfo| { &mut m.ENFPKOPNHKK },
        ));
...
impl ::protobuf::Message for InferenceWordInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                8 => {
                    self.DHBPEBDBMNK = is.read_bool()?;
                },
                16 => {
                    self.CAJHCPIPBOO = is.read_bool()?;
                },
                32 => {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        if self.DHBPEBDBMNK != false {
            my_size += 1 + 1;
        }
        if self.CAJHCPIPBOO != false {
            my_size += 1 + 1;
        }
        if self.word_id != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.word_id);
        }
        if self.unlock_by_word_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.unlock_by_word_id);
        }
        if self.ENFPKOPNHKK != false {
            my_size += 1 + 1;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.DHBPEBDBMNK != false {
            os.write_bool(1, self.DHBPEBDBMNK)?;
        }
        if self.CAJHCPIPBOO != false {
            os.write_bool(2, self.CAJHCPIPBOO)?;
        }
        if self.word_id != 0 {
            os.write_uint32(4, self.word_id)?;
        }
        if self.unlock_by_word_id != 0 {
            os.write_uint32(5, self.unlock_by_word_id)?;
        }
        if self.ENFPKOPNHKK != false {
            os.write_bool(11, self.ENFPKOPNHKK)?;
        }
    ...
    fn clear(&mut self) {
        self.DHBPEBDBMNK = false;
        self.CAJHCPIPBOO = false;
        self.word_id = 0;
        self.unlock_by_word_id = 0;
        self.ENFPKOPNHKK = false;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x17InferenceWordInfo.proto\"\xbd\x01\n\x11InferenceWordInfo\x12\x20\n\
    \x0bDHBPEBDBMNK\x18\x01\x20\x01(\x08R\x0bDHBPEBDBMNK\x12\x20\n\x0bCAJHCP\
    IPBOO\x18\x02\x20\x01(\x08R\x0bCAJHCPIPBOO\x12\x17\n\x07word_id\x18\x04\
    \x20\x01(\rR\x06wordId\x12)\n\x11unlock_by_word_id\x18\x05\x20\x01(\rR\
    \x0eunlockByWordId\x12\x20\n\x0bENFPKOPNHKK\x18\x0b\x20\x01(\x08R\x0bENF\
