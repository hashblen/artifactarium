    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if let ::std::option::Option::Some(ref v) = self.param {
            match v {
                ...
                &quick_use_widget_rsp::Param::SkyCrystalDetectorQuickUseResult(ref v) => {
                    ::protobuf::rt::write_message_field_with_cached_size(207036, v, os)?;
                },
            };
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    alId\x12E\n\rdetector_data\x18\x07\x20\x01(\x0b2\x1e.OneoffGatherPointDe\
    tectorDataH\0R\x0cdetectorData\x12J\n\x15client_collector_data\x18\x0e\
    \x20\x01(\x0b2\x14.ClientCollectorDataH\0R\x13clientCollectorData\x12v\n\
    %sky_crystal_detector_quick_use_result\x18\xbc\xd1\x0c\x20\x01(\x0b2!.Sk\
