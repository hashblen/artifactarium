...
impl DungeonChallengeFinishNotify {
    ...
    // .PotionDungeonResultInfo potion_dungeon_result_info = 354;
...
impl ::protobuf::Message for DungeonChallengeFinishNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.challenge_index != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.challenge_index);
        }
        ...
        if self.current_value != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.current_value);
        }
        if self.time_cost != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.time_cost);
        }
        if self.challenge_record_type != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.challenge_record_type);
        }
        if self.is_new_record != false {
            my_size += 1 + 1;
        }
        if self.finish_type != ::protobuf::EnumOrUnknown::new(super::ChallengeFinishType::ChallengeFinishType::ChallengeFinishType_NONE) {
            my_size += ::protobuf::rt::int32_size(14, self.finish_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.challenge_index != 0 {
            os.write_uint32(2, self.challenge_index)?;
        }
        for (k, v) in &self.strengthen_point_data_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
        ...
        if self.current_value != 0 {
            os.write_uint32(6, self.current_value)?;
        }
        if self.time_cost != 0 {
            os.write_uint32(8, self.time_cost)?;
        }
        if self.challenge_record_type != 0 {
            os.write_uint32(10, self.challenge_record_type)?;
        }
        if self.is_new_record != false {
            os.write_bool(13, self.is_new_record)?;
        }
        if self.finish_type != ::protobuf::EnumOrUnknown::new(super::ChallengeFinishType::ChallengeFinishType::ChallengeFinishType_NONE) {
            os.write_enum(14, ::protobuf::EnumOrUnknown::value(&self.finish_type))?;
        }
        if let ::std::option::Option::Some(ref v) = self.detail {
            match v {
                &dungeon_challenge_finish_notify::Detail::CustomDungeonResultInfo(ref v) => {
    ...
    fn clear(&mut self) {
        ...
        self.finish_type = ::protobuf::EnumOrUnknown::new(super::ChallengeFinishType::ChallengeFinishType::ChallengeFinishType_NONE);
        self.detail = ::std::option::Option::None;
        self.detail = ::std::option::Option::None;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\"DungeonChallengeFinishNotify.proto\x1a\x19StrengthenPointData.proto\
    \x1a\x19ChallengeFinishType.proto\x1a\x1dCustomDungeonResultInfo.proto\
    \x1a\x1dPotionDungeonResultInfo.proto\"\xcc\x05\n\x1cDungeonChallengeFin\
    ishNotify\x12'\n\x0fchallenge_index\x18\x02\x20\x01(\rR\x0echallengeInde\
    x\x12t\n\x19strengthen_point_data_map\x18\x04\x20\x03(\x0b29.DungeonChal\
    lengeFinishNotify.StrengthenPointDataMapEntryR\x16strengthenPointDataMap\
    \x12\x1d\n\nis_success\x18\x05\x20\x01(\x08R\tisSuccess\x12#\n\rcurrent_\
    value\x18\x06\x20\x01(\rR\x0ccurrentValue\x12\x1b\n\ttime_cost\x18\x08\
    \x20\x01(\rR\x08timeCost\x122\n\x15challenge_record_type\x18\n\x20\x01(\
    \rR\x13challengeRecordType\x12\"\n\ris_new_record\x18\r\x20\x01(\x08R\
    \x0bisNewRecord\x125\n\x0bfinish_type\x18\x0e\x20\x01(\x0e2\x14.Challeng\
    eFinishTypeR\nfinishType\x12X\n\x1acustom_dungeon_result_info\x18\xcf\
    \x01\x20\x01(\x0b2\x18.CustomDungeonResultInfoH\0R\x17customDungeonResul\
    tInfo\x12X\n\x1apotion_dungeon_result_info\x18\xe2\x02\x20\x01(\x0b2\x18\
    .PotionDungeonResultInfoH\0R\x17potionDungeonResultInfo\x1a_\n\x1bStreng\
    thenPointDataMapEntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\x12*\n\
    \x05value\x18\x02\x20\x01(\x0b2\x14.StrengthenPointDataR\x05value:\x028\
