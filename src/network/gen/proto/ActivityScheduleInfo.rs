...
impl ::protobuf::Message for ActivityScheduleInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.end_time != 0 {
            my_size += ::protobuf::rt::uint32_size(13, self.end_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.end_time != 0 {
            os.write_uint32(13, self.end_time)?;
        }
        if self.schedule_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x1d\n\nbegin_time\x18\x06\x20\x01(\rR\tbeginTime\x12\x1f\n\x0bactivity_\
    id\x18\x07\x20\x01(\rR\nactivityId\x12\x17\n\x07is_open\x18\t\x20\x01(\
    \x08R\x06isOpen\x12\x19\n\x08end_time\x18\r\x20\x01(\rR\x07endTime\x12\
