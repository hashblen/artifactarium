...
impl ::protobuf::Message for PlayerWorldSceneInfo {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.scene_tag_id_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint32(5, &self.scene_tag_id_list)?;
        if self.is_locked != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14PlayerWorldSceneInfo\x12)\n\x11scene_tag_id_list\x18\x05\x20\x03(\rR\
    \x0esceneTagIdList\x12\x1b\n\tis_locked\x18\n\x20\x01(\x08R\x08isLocked\
    \x12\x19\n\x08scene_id\x18\x0b\x20\x01(\rR\x07sceneId\x123\n\x0emap_laye\
    r_info\x18\x0e\x20\x01(\x0b2\r.MapLayerInfoR\x0cmapLayerInfoB\x1b\n\x19e\
