...
impl ::protobuf::Message for ChangeMpTeamAvatarRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_uint64_size(4, &self.avatar_guid_list);
        if self.cur_avatar_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(3, self.cur_avatar_guid);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_uint64(4, &self.avatar_guid_list)?;
        if self.cur_avatar_guid != 0 {
            os.write_uint64(3, self.cur_avatar_guid)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x12(\n\x10avatar_guid_list\x18\x04\x20\x03(\x04R\x0eavatarGuidList\x12&\
    \n\x0fcur_avatar_guid\x18\x03\x20\x01(\x04R\rcurAvatarGuid\x12\x18\n\x07\
    retcode\x18\x0e\x20\x01(\x05R\x07retcodeB\x1b\n\x19emu.grasscutter.net.p\
    rotob\x06proto3\
";
