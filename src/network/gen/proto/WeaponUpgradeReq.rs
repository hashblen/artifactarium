...
impl ::protobuf::Message for WeaponUpgradeReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.target_weapon_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(10, self.target_weapon_guid);
        }
        my_size += ::protobuf::rt::vec_packed_uint64_size(3, &self.food_weapon_guid_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.target_weapon_guid != 0 {
            os.write_uint64(10, self.target_weapon_guid)?;
        }
        os.write_repeated_packed_uint64(3, &self.food_weapon_guid_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    nUpgradeReq\x122\n\x0fitem_param_list\x18\r\x20\x03(\x0b2\n.ItemParamR\r\
    itemParamList\x12,\n\x12target_weapon_guid\x18\n\x20\x01(\x04R\x10target\
    WeaponGuid\x121\n\x15food_weapon_guid_list\x18\x03\x20\x03(\x04R\x12food\
