...
impl ::protobuf::Message for Achievement {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_progress != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.total_progress);
        }
        if self.finish_timestamp != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.finish_timestamp);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.total_progress != 0 {
            os.write_uint32(4, self.total_progress)?;
        }
        if self.finish_timestamp != 0 {
            os.write_uint32(8, self.finish_timestamp)?;
        }
        if self.status != ::protobuf::EnumOrUnknown::new(achievement::Status::STATUS_INVALID) {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    s\x18\x03\x20\x01(\rR\x0bcurProgress\x12%\n\x0etotal_progress\x18\x04\
    \x20\x01(\rR\rtotalProgress\x12)\n\x10finish_timestamp\x18\x08\x20\x01(\
    \rR\x0ffinishTimestamp\x12+\n\x06status\x18\t\x20\x01(\x0e2\x13.Achievem\
    ent.StatusR\x06status\x12\x0e\n\x02id\x18\x0f\x20\x01(\rR\x02id\"a\n\x06\
    Status\x12\x12\n\x0eSTATUS_INVALID\x10\0\x12\x15\n\x11STATUS_UNFINISHED\
