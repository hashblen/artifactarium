...
pub struct VehicleInfo {
    ...
    pub cur_stamina: f32,
    // @@protoc_insertion_point(field:VehicleInfo.GPMPAEGBEJE)
    pub GPMPAEGBEJE: u32,
    // @@protoc_insertion_point(field:VehicleInfo.LLGKENMIENL)
    pub LLGKENMIENL: f32,
    // @@protoc_insertion_point(field:VehicleInfo.anim_hash)
    pub anim_hash: u32,
    // special fields
...
impl VehicleInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "GPMPAEGBEJE",
            |m: &VehicleInfo| { &m.GPMPAEGBEJE },
            |m: &mut VehicleInfo| { &mut m.GPMPAEGBEJE },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "LLGKENMIENL",
            |m: &VehicleInfo| { &m.LLGKENMIENL },
            |m: &mut VehicleInfo| { &mut m.LLGKENMIENL },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "anim_hash",
            |m: &VehicleInfo| { &m.anim_hash },
            |m: &mut VehicleInfo| { &mut m.anim_hash },
        ));
...
impl ::protobuf::Message for VehicleInfo {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                32 => {
                    self.GPMPAEGBEJE = is.read_uint32()?;
                },
                45 => {
                    self.LLGKENMIENL = is.read_float()?;
                },
                48 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.GPMPAEGBEJE != 0 {
            my_size += ::protobuf::rt::uint32_size(4, self.GPMPAEGBEJE);
        }
        if self.LLGKENMIENL != 0. {
            my_size += 1 + 4;
        }
        if self.anim_hash != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.anim_hash);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.GPMPAEGBEJE != 0 {
            os.write_uint32(4, self.GPMPAEGBEJE)?;
        }
        if self.LLGKENMIENL != 0. {
            os.write_float(5, self.LLGKENMIENL)?;
        }
        if self.anim_hash != 0 {
            os.write_uint32(6, self.anim_hash)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x11VehicleInfo.proto\x1a\x13VehicleMember.proto\"\xdd\x01\n\x0bVehicl\
    eInfo\x12/\n\x0bmember_list\x18\x01\x20\x03(\x0b2\x0e.VehicleMemberR\nme\
    mberList\x12\x1b\n\towner_uid\x18\x02\x20\x01(\rR\x08ownerUid\x12\x1f\n\
    \x0bcur_stamina\x18\x03\x20\x01(\x02R\ncurStamina\x12\x20\n\x0bGPMPAEGBE\
    JE\x18\x04\x20\x01(\rR\x0bGPMPAEGBEJE\x12\x20\n\x0bLLGKENMIENL\x18\x05\
    \x20\x01(\x02R\x0bLLGKENMIENL\x12\x1b\n\tanim_hash\x18\x06\x20\x01(\rR\
