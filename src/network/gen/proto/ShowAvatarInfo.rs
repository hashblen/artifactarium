...
impl ::protobuf::Message for ShowAvatarInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(3, &self.talent_id_list);
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(7, &self.inherent_proud_skill_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(3, &self.talent_id_list)?;
        for (k, v) in &self.fight_prop_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
            entry_size += 1 + 4;
        ...
        os.write_repeated_packed_uint32(7, &self.inherent_proud_skill_list)?;
        for (k, v) in &self.skill_level_map {
            let mut entry_size = 0;
            entry_size += ::protobuf::rt::uint32_size(1, *k);
            entry_size += ::protobuf::rt::uint32_size(2, *v);
