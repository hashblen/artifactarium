...
pub struct AvatarLifeStateChangeNotify {
    ...
    // @@protoc_insertion_point(field:AvatarLifeStateChangeNotify.EPGOBHIEDOI)
...
impl AvatarLifeStateChangeNotify {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_vec_simpler_accessor::<_, _>(
            "EPGOBHIEDOI",
            |m: &AvatarLifeStateChangeNotify| { &m.EPGOBHIEDOI },
            |m: &mut AvatarLifeStateChangeNotify| { &mut m.EPGOBHIEDOI },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "die_type",
...
impl ::protobuf::Message for AvatarLifeStateChangeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.source_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.source_entity_id);
        }
        ...
        if self.die_type != ::protobuf::EnumOrUnknown::new(super::PlayerDieType::PlayerDieType::PLAYER_DIE_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(5, self.die_type.value());
        }
        ...
        if self.life_state != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.life_state);
        }
        ...
        if !self.attack_tag.is_empty() {
            my_size += ::protobuf::rt::string_size(15, &self.attack_tag);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.source_entity_id != 0 {
            os.write_uint32(2, self.source_entity_id)?;
        }
        for v in &self.EPGOBHIEDOI {
            os.write_string(3, &v)?;
        };
        if self.die_type != ::protobuf::EnumOrUnknown::new(super::PlayerDieType::PlayerDieType::PLAYER_DIE_TYPE_NONE) {
            os.write_enum(5, ::protobuf::EnumOrUnknown::value(&self.die_type))?;
        }
        if self.avatar_guid != 0 {
        ...
        if self.life_state != 0 {
            os.write_uint32(11, self.life_state)?;
        }
        for v in &self.server_buff_list {
            ::protobuf::rt::write_message_field_with_cached_size(14, v, os)?;
        };
        if !self.attack_tag.is_empty() {
            os.write_string(15, &self.attack_tag)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n!AvatarLifeStateChangeNotify.proto\x1a\x13PlayerDieType.proto\x1a\x10S\
    erverBuff.proto\"\xd6\x02\n\x1bAvatarLifeStateChangeNotify\x12(\n\x10sou\
    rce_entity_id\x18\x02\x20\x01(\rR\x0esourceEntityId\x12\x20\n\x0bEPGOBHI\
    EDOI\x18\x03\x20\x03(\tR\x0bEPGOBHIEDOI\x12)\n\x08die_type\x18\x05\x20\
    \x01(\x0e2\x0e.PlayerDieTypeR\x07dieType\x12\x1f\n\x0bavatar_guid\x18\t\
    \x20\x01(\x04R\navatarGuid\x12*\n\x11move_reliable_seq\x18\n\x20\x01(\rR\
    \x0fmoveReliableSeq\x12\x1d\n\nlife_state\x18\x0b\x20\x01(\rR\tlifeState\
    \x125\n\x10server_buff_list\x18\x0e\x20\x03(\x0b2\x0b.ServerBuffR\x0eser\
    verBuffList\x12\x1d\n\nattack_tag\x18\x0f\x20\x01(\tR\tattackTagB\x1b\n\
