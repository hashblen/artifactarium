...
pub struct SceneWeaponInfo {
    ...
    // @@protoc_insertion_point(field:SceneWeaponInfo.HHLNNPOILDL)
    pub HHLNNPOILDL: bool,
    // special fields
...
impl SceneWeaponInfo {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "HHLNNPOILDL",
            |m: &SceneWeaponInfo| { &m.HHLNNPOILDL },
            |m: &mut SceneWeaponInfo| { &mut m.HHLNNPOILDL },
        ));
...
impl ::protobuf::Message for SceneWeaponInfo {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.HHLNNPOILDL != false {
            os.write_bool(10, self.HHLNNPOILDL)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ityRendererChangedInfo.proto\"\xd9\x03\n\x0fSceneWeaponInfo\x12\x1b\n\te\
