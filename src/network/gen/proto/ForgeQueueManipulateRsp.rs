...
impl ::protobuf::Message for ForgeQueueManipulateRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.manipulate_type != ::protobuf::EnumOrUnknown::new(super::ForgeQueueManipulateType::ForgeQueueManipulateType::FORGE_QUEUE_MANIPULATE_TYPE_RECEIVE_OUTPUT) {
            my_size += ::protobuf::rt::int32_size(8, self.manipulate_type.value());
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.manipulate_type != ::protobuf::EnumOrUnknown::new(super::ForgeQueueManipulateType::ForgeQueueManipulateType::FORGE_QUEUE_MANIPULATE_TYPE_RECEIVE_OUTPUT) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.manipulate_type))?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    t\x12?\n\x16extra_output_item_list\x18\x0b\x20\x03(\x0b2\n.ItemParamR\
    \x13extraOutputItemList\x12B\n\x0fmanipulate_type\x18\x08\x20\x01(\x0e2\
    \x19.ForgeQueueManipulateTypeR\x0emanipulateType\x124\n\x10return_item_l\
    ist\x18\x07\x20\x03(\x0b2\n.ItemParamR\x0ereturnItemList\x12\x18\n\x07re\
    tcode\x18\x03\x20\x01(\x05R\x07retcodeB\x1b\n\x19emu.grasscutter.net.pro\
    tob\x06proto3\
";
