...
pub struct Quest {
    ...
    // @@protoc_insertion_point(field:Quest.MLHFBAFCKIP)
    pub MLHFBAFCKIP: ::std::vec::Vec<u32>,
    // @@protoc_insertion_point(field:Quest.EBPOIBHNPNH)
    pub EBPOIBHNPNH: ::protobuf::MessageField<super::LackingResourceInfo::LackingResourceInfo>,
    // special fields
...
impl ::protobuf::Message for Quest {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                98 => {
                    is.read_repeated_packed_uint32_into(&mut self.MLHFBAFCKIP)?;
                },
                96 => {
                    self.MLHFBAFCKIP.push(is.read_uint32()?);
                },
                106 => {
                    ::protobuf::rt::read_singular_message_into_field(is, &mut self.EBPOIBHNPNH)?;
                },
                tag => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.finish_progress_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.fail_progress_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.MLHFBAFCKIP);
        if let Some(v) = self.EBPOIBHNPNH.as_ref() {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(10, &self.finish_progress_list)?;
        os.write_repeated_packed_uint32(11, &self.fail_progress_list)?;
        os.write_repeated_packed_uint32(12, &self.MLHFBAFCKIP)?;
        if let Some(v) = self.EBPOIBHNPNH.as_ref() {
    ...
    fn clear(&mut self) {
        ...
        self.MLHFBAFCKIP.clear();
        self.EBPOIBHNPNH.clear();
    ...
    fn default_instance() -> &'static Quest {
        static instance: Quest = Quest {
            ...
            MLHFBAFCKIP: ::std::vec::Vec::new(),
            EBPOIBHNPNH: ::protobuf::MessageField::none(),
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x10failProgressList\x12\x20\n\x0bMLHFBAFCKIP\x18\x0c\x20\x03(\rR\x0bMLH\
    FBAFCKIP\x126\n\x0bEBPOIBHNPNH\x18\r\x20\x01(\x0b2\x14.LackingResourceIn\
    foR\x0bEBPOIBHNPNHB\x1b\n\x19emu.grasscutter.net.protob\x06proto3\
";
