...
impl ::protobuf::Message for SceneTeamAvatar {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.weapon_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(6, self.weapon_entity_id);
        }
        ...
        if self.weapon_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(10, self.weapon_guid);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_reconnect != false {
            os.write_bool(1, self.is_reconnect)?;
        }
        if self.scene_id != 0 {
        ...
        if self.weapon_entity_id != 0 {
            os.write_uint32(6, self.weapon_entity_id)?;
        }
        if self.player_uid != 0 {
        ...
        if self.weapon_guid != 0 {
            os.write_uint64(10, self.weapon_guid)?;
        }
        if let Some(v) = self.avatar_ability_info.as_ref() {
        ...
        if self.is_player_cur_avatar != false {
            os.write_bool(14, self.is_player_cur_avatar)?;
        }
        if self.avatar_guid != 0 {
            os.write_uint64(15, self.avatar_guid)?;
        }
        if self.is_on_scene != false {
            os.write_bool(588, self.is_on_scene)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15SceneTeamAvatar.proto\x1a\x10ServerBuff.proto\x1a\x10AvatarInfo.pr\
    oto\x1a\x15SceneEntityInfo.proto\x1a\x19AbilityControlBlock.proto\x1a\
    \x1aAbilitySyncStateInfo.proto\x1a\x15SceneAvatarInfo.proto\"\x82\x06\n\
    \x0fSceneTeamAvatar\x12!\n\x0cis_reconnect\x18\x01\x20\x01(\x08R\x0bisRe\
    connect\x12\x19\n\x08scene_id\x18\x02\x20\x01(\rR\x07sceneId\x125\n\x10s\
    erver_buff_list\x18\x03\x20\x03(\x0b2\x0b.ServerBuffR\x0eserverBuffList\
    \x12,\n\x0bavatar_info\x18\x04\x20\x01(\x0b2\x0b.AvatarInfoR\navatarInfo\
    \x12<\n\x11scene_entity_info\x18\x05\x20\x01(\x0b2\x10.SceneEntityInfoR\
    \x0fsceneEntityInfo\x12(\n\x10weapon_entity_id\x18\x06\x20\x01(\rR\x0ewe\
    aponEntityId\x12\x1d\n\nplayer_uid\x18\x07\x20\x01(\rR\tplayerUid\x12H\n\
    \x15ability_control_block\x18\x08\x20\x01(\x0b2\x14.AbilityControlBlockR\
    \x13abilityControlBlock\x12\x1b\n\tentity_id\x18\t\x20\x01(\rR\x08entity\
    Id\x12\x1f\n\x0bweapon_guid\x18\n\x20\x01(\x04R\nweaponGuid\x12E\n\x13av\
    atar_ability_info\x18\x0b\x20\x01(\x0b2\x15.AbilitySyncStateInfoR\x11ava\
    tarAbilityInfo\x12E\n\x13weapon_ability_info\x18\x0c\x20\x01(\x0b2\x15.A\
    bilitySyncStateInfoR\x11weaponAbilityInfo\x12<\n\x11scene_avatar_info\
    \x18\r\x20\x01(\x0b2\x10.SceneAvatarInfoR\x0fsceneAvatarInfo\x12/\n\x14i\
    s_player_cur_avatar\x18\x0e\x20\x01(\x08R\x11isPlayerCurAvatar\x12\x1f\n\
    \x0bavatar_guid\x18\x0f\x20\x01(\x04R\navatarGuid\x12\x1f\n\x0bis_on_sce\
    ne\x18\xcc\x04\x20\x01(\x08R\tisOnSceneB\x1b\n\x19emu.grasscutter.net.pr\
    otob\x06proto3\
";
