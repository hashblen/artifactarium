...
impl ::protobuf::Message for TeamEnterSceneInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.team_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.team_entity_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.team_entity_id != 0 {
            os.write_uint32(1, self.team_entity_id)?;
        }
        if let Some(v) = self.team_ability_info.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x18TeamEnterSceneInfo.proto\x1a\x1aAbilitySyncStateInfo.proto\x1a\x19\
    AbilityControlBlock.proto\"\xc7\x01\n\x12TeamEnterSceneInfo\x12$\n\x0ete\
    am_entity_id\x18\x01\x20\x01(\rR\x0cteamEntityId\x12A\n\x11team_ability_\
    info\x18\x05\x20\x01(\x0b2\x15.AbilitySyncStateInfoR\x0fteamAbilityInfo\
    \x12H\n\x15ability_control_block\x18\x0f\x20\x01(\x0b2\x14.AbilityContro\
    lBlockR\x13abilityControlBlockB\x1b\n\x19emu.grasscutter.net.protob\x06p\
    roto3\
";
