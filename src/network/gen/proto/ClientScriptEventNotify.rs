...
impl ::protobuf::Message for ClientScriptEventNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.source_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.source_entity_id);
        }
        if self.target_entity_id != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.target_entity_id);
        }
        if self.event_type != 0 {
            my_size += ::protobuf::rt::uint32_size(10, self.event_type);
        }
        my_size += ::protobuf::rt::vec_packed_int32_size(4, &self.param_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.source_entity_id != 0 {
            os.write_uint32(5, self.source_entity_id)?;
        }
        if self.target_entity_id != 0 {
            os.write_uint32(2, self.target_entity_id)?;
        }
        if self.event_type != 0 {
            os.write_uint32(10, self.event_type)?;
        }
        os.write_repeated_packed_int32(4, &self.param_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    fy\x12(\n\x10source_entity_id\x18\x05\x20\x01(\rR\x0esourceEntityId\x12(\
    \n\x10target_entity_id\x18\x02\x20\x01(\rR\x0etargetEntityId\x12\x1d\n\n\
    event_type\x18\n\x20\x01(\rR\teventType\x12\x1d\n\nparam_list\x18\x04\
