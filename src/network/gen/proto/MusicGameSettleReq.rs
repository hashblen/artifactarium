...
impl ::protobuf::Message for MusicGameSettleReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(327, &self.OEAHADEGEOA);
        if self.ugc_guid != 0 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(5, &self.KPPICEDHMPN);
        if self.speed != 0. {
            my_size += 2 + 4;
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(327, &self.OEAHADEGEOA)?;
        if self.ugc_guid != 0 {
        ...
        os.write_repeated_packed_uint32(5, &self.KPPICEDHMPN)?;
        if self.speed != 0. {
