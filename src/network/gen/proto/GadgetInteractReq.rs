...
pub struct GadgetInteractReq {
    ...
    // @@protoc_insertion_point(field:GadgetInteractReq.CHDDOFMLBLM)
    pub CHDDOFMLBLM: u32,
...
impl GadgetInteractReq {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "CHDDOFMLBLM",
            |m: &GadgetInteractReq| { &m.CHDDOFMLBLM },
            |m: &mut GadgetInteractReq| { &mut m.CHDDOFMLBLM },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "gadget_entity_id",
...
impl ::protobuf::Message for GadgetInteractReq {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.ui_interact_id != 0 {
            my_size += ::protobuf::rt::uint32_size(5, self.ui_interact_id);
        }
        ...
        if self.resin_cost_type != ::protobuf::EnumOrUnknown::new(super::ResinCostType::ResinCostType::RESIN_COST_TYPE_NONE) {
            my_size += ::protobuf::rt::int32_size(11, self.resin_cost_type.value());
        }
        if self.CHDDOFMLBLM != 0 {
            my_size += ::protobuf::rt::uint32_size(9, self.CHDDOFMLBLM);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.ui_interact_id != 0 {
            os.write_uint32(5, self.ui_interact_id)?;
        }
        if self.op_type != ::protobuf::EnumOrUnknown::new(super::InterOpType::InterOpType::INTER_OP_TYPE_FINISH) {
            os.write_enum(4, ::protobuf::EnumOrUnknown::value(&self.op_type))?;
        }
        if self.is_use_condense_resin != false {
            os.write_bool(15, self.is_use_condense_resin)?;
        }
        if self.gadget_id != 0 {
            os.write_uint32(3, self.gadget_id)?;
        }
        if self.resin_cost_type != ::protobuf::EnumOrUnknown::new(super::ResinCostType::ResinCostType::RESIN_COST_TYPE_NONE) {
            os.write_enum(11, ::protobuf::EnumOrUnknown::value(&self.resin_cost_type))?;
        }
        if self.CHDDOFMLBLM != 0 {
            os.write_uint32(9, self.CHDDOFMLBLM)?;
        }
        if self.gadget_entity_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    ype.proto\"\xb4\x02\n\x11GadgetInteractReq\x12$\n\x0eui_interact_id\x18\
    \x05\x20\x01(\rR\x0cuiInteractId\x12%\n\x07op_type\x18\x04\x20\x01(\x0e2\
    \x0c.InterOpTypeR\x06opType\x121\n\x15is_use_condense_resin\x18\x0f\x20\
    \x01(\x08R\x12isUseCondenseResin\x12\x1b\n\tgadget_id\x18\x03\x20\x01(\r\
    R\x08gadgetId\x126\n\x0fresin_cost_type\x18\x0b\x20\x01(\x0e2\x0e.ResinC\
    ostTypeR\rresinCostType\x12\x20\n\x0bCHDDOFMLBLM\x18\t\x20\x01(\rR\x0bCH\
    DDOFMLBLM\x12(\n\x10gadget_entity_id\x18\x0c\x20\x01(\rR\x0egadgetEntity\
