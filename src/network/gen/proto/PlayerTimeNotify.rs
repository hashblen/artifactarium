...
impl ::protobuf::Message for PlayerTimeNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.server_time != 0 {
            my_size += ::protobuf::rt::uint64_size(7, self.server_time);
        }
        if self.player_time != 0 {
            my_size += ::protobuf::rt::uint64_size(8, self.player_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.is_paused != false {
            os.write_bool(3, self.is_paused)?;
        }
        if self.server_time != 0 {
            os.write_uint64(7, self.server_time)?;
        }
        if self.player_time != 0 {
            os.write_uint64(8, self.player_time)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x16PlayerTimeNotify.proto\"q\n\x10PlayerTimeNotify\x12\x1b\n\tis_paus\
    ed\x18\x03\x20\x01(\x08R\x08isPaused\x12\x1f\n\x0bserver_time\x18\x07\
    \x20\x01(\x04R\nserverTime\x12\x1f\n\x0bplayer_time\x18\x08\x20\x01(\x04\
