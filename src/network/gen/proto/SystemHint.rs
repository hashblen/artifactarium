...
//! Generated file from `SystemHint.proto`

/// Generated files are compatible only with the same version
/// of protobuf runtime.
const _PROTOBUF_VERSION_CHECK: () = ::protobuf::VERSION_3_5_1;

// @@protoc_insertion_point(message:SystemHint)
#[derive(PartialEq,Clone,Default,Debug)]
pub struct SystemHint {
    // message fields
    // @@protoc_insertion_point(field:SystemHint.type)
    pub type_: u32,
    // special fields
    // @@protoc_insertion_point(special_field:SystemHint.special_fields)
...
impl ::protobuf::MessageFull for SystemHint {
    fn descriptor() -> ::protobuf::reflect::MessageDescriptor {
        ...
        descriptor.get(|| file_descriptor().message_by_package_relative_name("SystemHint").unwrap()).clone()
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            messages.push(SystemHint::generated_message_descriptor_data());
