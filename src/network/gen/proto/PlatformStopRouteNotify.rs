...
impl ::protobuf::Message for PlatformStopRouteNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.scene_time != 0 {
            my_size += ::protobuf::rt::uint32_size(2, self.scene_time);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.scene_time != 0 {
            os.write_uint32(2, self.scene_time)?;
        }
        if let Some(v) = self.platform.as_ref() {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x17PlatformStopRouteNotify\x12\x1d\n\nscene_time\x18\x02\x20\x01(\rR\
    \tsceneTime\x12)\n\x08platform\x18\x05\x20\x01(\x0b2\r.PlatformInfoR\x08\
    platform\x12\x1b\n\tentity_id\x18\x0c\x20\x01(\rR\x08entityIdB\x1b\n\x19\
