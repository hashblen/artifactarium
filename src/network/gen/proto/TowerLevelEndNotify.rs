...
impl ::protobuf::Message for TowerLevelEndNotify {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.next_floor_id != 0 {
            my_size += ::protobuf::rt::uint32_size(3, self.next_floor_id);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.finished_star_cond_list);
        if self.continue_state != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.continue_state);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.next_floor_id != 0 {
            os.write_uint32(3, self.next_floor_id)?;
        }
        os.write_repeated_packed_uint32(8, &self.finished_star_cond_list)?;
        if self.continue_state != 0 {
            os.write_uint32(11, self.continue_state)?;
        }
        if self.is_success != false {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    werLevelEndNotify\x124\n\x10reward_item_list\x18\x01\x20\x03(\x0b2\n.Ite\
    mParamR\x0erewardItemList\x12\"\n\rnext_floor_id\x18\x03\x20\x01(\rR\x0b\
    nextFloorId\x125\n\x17finished_star_cond_list\x18\x08\x20\x03(\rR\x14fin\
    ishedStarCondList\x12%\n\x0econtinue_state\x18\x0b\x20\x01(\rR\rcontinue\
    State\x12\x1d\n\nis_success\x18\x0c\x20\x01(\x08R\tisSuccess\"\x99\x01\n\
