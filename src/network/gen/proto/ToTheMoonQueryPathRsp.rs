...
impl ::protobuf::Message for ToTheMoonQueryPathRsp {
    ...
    fn compute_size(&self) -> u64 {
        let mut my_size = 0;
        my_size += ::protobuf::rt::vec_packed_int32_size(1, &self.level);
        if self.retcode != 0 {
        ...
        if self.query_status != ::protobuf::EnumOrUnknown::new(super::PathStatusType::PathStatusType::PATH_STATUS_TYPE_FAIL) {
            my_size += ::protobuf::rt::int32_size(10, self.query_status.value());
        }
        if self.query_id != 0 {
            my_size += ::protobuf::rt::int32_size(13, self.query_id);
        }
        my_size += ::protobuf::rt::vec_packed_int64_size(15, &self.index);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        os.write_repeated_packed_int32(1, &self.level)?;
        if self.retcode != 0 {
        ...
        if self.query_status != ::protobuf::EnumOrUnknown::new(super::PathStatusType::PathStatusType::PATH_STATUS_TYPE_FAIL) {
            os.write_enum(10, ::protobuf::EnumOrUnknown::value(&self.query_status))?;
        }
        if self.query_id != 0 {
            os.write_int32(13, self.query_id)?;
        }
        os.write_repeated_packed_int64(15, &self.index)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x1bToTheMoonQueryPathRsp.proto\x1a\x0cVector.proto\x1a\x14PathStatusT\
    ype.proto\"\xcf\x01\n\x15ToTheMoonQueryPathRsp\x12\x14\n\x05level\x18\
    \x01\x20\x03(\x05R\x05level\x12\x18\n\x07retcode\x18\x07\x20\x01(\x05R\
    \x07retcode\x12!\n\x07corners\x18\t\x20\x03(\x0b2\x07.VectorR\x07corners\
    \x122\n\x0cquery_status\x18\n\x20\x01(\x0e2\x0f.PathStatusTypeR\x0bquery\
    Status\x12\x19\n\x08query_id\x18\r\x20\x01(\x05R\x07queryId\x12\x14\n\
    \x05index\x18\x0f\x20\x03(\x03R\x05indexB\x1b\n\x19emu.grasscutter.net.p\
    rotob\x06proto3\
";
