...
impl ::protobuf::Message for ActivityWatcherInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.total_progress != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.total_progress);
        }
        if self.cur_progress != 0 {
            my_size += ::protobuf::rt::uint32_size(8, self.cur_progress);
        }
        if self.is_taken_reward != false {
            my_size += 1 + 1;
        }
        if self.watcher_id != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.watcher_id);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.total_progress != 0 {
            os.write_uint32(7, self.total_progress)?;
        }
        if self.cur_progress != 0 {
            os.write_uint32(8, self.cur_progress)?;
        }
        if self.is_taken_reward != false {
            os.write_bool(9, self.is_taken_reward)?;
        }
        if self.watcher_id != 0 {
            os.write_uint32(11, self.watcher_id)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x0etotal_progress\x18\x07\x20\x01(\rR\rtotalProgress\x12!\n\x0ccur_pr\
    ogress\x18\x08\x20\x01(\rR\x0bcurProgress\x12&\n\x0fis_taken_reward\x18\
    \t\x20\x01(\x08R\risTakenReward\x12\x1d\n\nwatcher_id\x18\x0b\x20\x01(\r\
