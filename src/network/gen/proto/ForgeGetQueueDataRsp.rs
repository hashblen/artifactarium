...
impl ::protobuf::Message for ForgeGetQueueDataRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.max_queue_num != 0 {
            my_size += ::protobuf::rt::uint32_size(12, self.max_queue_num);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.max_queue_num != 0 {
            os.write_uint32(12, self.max_queue_num)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x14ForgeGetQueueDataRsp\x12\"\n\rmax_queue_num\x18\x0c\x20\x01(\rR\x0bm\
    axQueueNum\x12\x18\n\x07retcode\x18\x0b\x20\x01(\x05R\x07retcode\x12P\n\
    \x0fforge_queue_map\x18\x01\x20\x03(\x0b2(.ForgeGetQueueDataRsp.ForgeQue\
