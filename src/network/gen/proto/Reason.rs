...
//! Generated file from `Reason.proto`
...
// @@protoc_insertion_point(enum:Reason)
pub enum Reason {
    // @@protoc_insertion_point(enum_value:Reason.INVALID)
    INVALID = 0,
    // @@protoc_insertion_point(enum_value:Reason.ENTER)
    ENTER = 1,
    // @@protoc_insertion_point(enum_value:Reason.LEAVE)
    LEAVE = 2,
}
...
impl ::protobuf::EnumFull for Reason {
    fn enum_descriptor() -> ::protobuf::reflect::EnumDescriptor {
        ...
        descriptor.get(|| file_descriptor().enum_by_package_relative_name("Reason").unwrap()).clone()
    }
...
impl Reason {
    fn generated_enum_descriptor_data() -> ::protobuf::reflect::GeneratedEnumDescriptorData {
        ::protobuf::reflect::GeneratedEnumDescriptorData::new::<Reason>("Reason")
    }
}
...
pub fn file_descriptor() -> &'static ::protobuf::reflect::FileDescriptor {
    ...
    file_descriptor.get(|| {
        let generated_file_descriptor = generated_file_descriptor_lazy.get(|| {
            ...
            enums.push(Reason::generated_enum_descriptor_data());
