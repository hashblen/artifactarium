...
impl ::protobuf::Message for OneoffGatherPointDetectorData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.hint_radius != 0 {
            my_size += ::protobuf::rt::uint32_size(1, self.hint_radius);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.is_hint_valid != false {
            os.write_bool(8, self.is_hint_valid)?;
        }
        if let Some(v) = self.hint_center_pos.as_ref() {
            ::protobuf::rt::write_message_field_with_cached_size(4, v, os)?;
        }
        if self.hint_radius != 0 {
            os.write_uint32(1, self.hint_radius)?;
        }
        if self.material_id != 0 {
        ...
        if self.is_all_collected != false {
            os.write_bool(13, self.is_all_collected)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n#OneoffGatherPointDetectorData.proto\x1a\x0cVector.proto\"\x98\x02\n\
    \x1dOneoffGatherPointDetectorData\x12\x1b\n\tconfig_id\x18\x0b\x20\x01(\
    \rR\x08configId\x12\"\n\ris_hint_valid\x18\x08\x20\x01(\x08R\x0bisHintVa\
    lid\x12/\n\x0fhint_center_pos\x18\x04\x20\x01(\x0b2\x07.VectorR\rhintCen\
    terPos\x12\x1f\n\x0bhint_radius\x18\x01\x20\x01(\rR\nhintRadius\x12\x1f\
    \n\x0bmaterial_id\x18\x02\x20\x01(\rR\nmaterialId\x12\x19\n\x08group_id\
    \x18\x07\x20\x01(\rR\x07groupId\x12(\n\x10is_all_collected\x18\r\x20\x01\
    (\x08R\x0eisAllCollectedB\x1b\n\x19emu.grasscutter.net.protob\x06proto3\
";
