...
impl ::protobuf::Message for HomeFurnitureGroupData {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.group_furniture_index != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.group_furniture_index);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.group_furniture_index != 0 {
            os.write_uint32(14, self.group_furniture_index)?;
        }
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x01\n\x16HomeFurnitureGroupData\x12F\n\x15virtual_furniure_list\x18\t\
    \x20\x03(\x0b2\x12.HomeFurnitureDataR\x13virtualFurniureList\x122\n\x15g\
    roup_furniture_index\x18\x0e\x20\x01(\rR\x13groupFurnitureIndexB\x1b\n\
