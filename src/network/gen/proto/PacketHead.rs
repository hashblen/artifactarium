...
pub struct PacketHead {
    ...
    // @@protoc_insertion_point(field:PacketHead.home_user_id)
    ...
    // @@protoc_insertion_point(field:PacketHead.sender_load)
    pub sender_load: u32,
    // @@protoc_insertion_point(field:PacketHead.span_context_str)
    pub span_context_str: ::std::vec::Vec<u8>,
...
impl PacketHead {
    ...
    fn generated_message_descriptor_data() -> ::protobuf::reflect::GeneratedMessageDescriptorData {
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "home_user_id",
            |m: &PacketHead| { &m.home_user_id },
            |m: &mut PacketHead| { &mut m.home_user_id },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "recv_time_ms",
        ...
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "sender_load",
            |m: &PacketHead| { &m.sender_load },
            |m: &mut PacketHead| { &mut m.sender_load },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "span_context_str",
            |m: &PacketHead| { &m.span_context_str },
            |m: &mut PacketHead| { &mut m.span_context_str },
        ));
        fields.push(::protobuf::reflect::rt::v2::make_simpler_field_accessor::<_, _>(
            "source_service",
...
impl ::protobuf::Message for PacketHead {
    ...
    fn merge_from(&mut self, is: &mut ::protobuf::CodedInputStream<'_>) -> ::protobuf::Result<()> {
        while let Some(tag) = is.read_raw_tag_or_eof()? {
            match tag {
                ...
                112 => {
                    self.home_user_id = is.read_uint32()?;
                },
                168 => {
                ...
                200 => {
                    self.sender_load = is.read_uint32()?;
                },
                210 => {
                    self.span_context_str = is.read_bytes()?;
                },
                248 => {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.home_user_id != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.home_user_id);
        }
        ...
        if self.sender_load != 0 {
            my_size += ::protobuf::rt::uint32_size(25, self.sender_load);
        }
        if !self.span_context_str.is_empty() {
            my_size += ::protobuf::rt::bytes_size(26, &self.span_context_str);
        }
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.home_user_id != 0 {
            os.write_uint32(14, self.home_user_id)?;
        }
        if self.recv_time_ms != 0 {
        ...
        if self.sender_load != 0 {
            os.write_uint32(25, self.sender_load)?;
        }
        if !self.span_context_str.is_empty() {
            os.write_bytes(26, &self.span_context_str)?;
        }
        if self.source_service != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x0chome_user_id\x18\x0e\x20\x01(\rR\nhomeUserId\x12\x20\n\x0crecv_time_\
    ms\x18\x15\x20\x01(\x04R\nrecvTimeMs\x12)\n\x11rpc_begin_time_ms\x18\x16\
    \x20\x01(\rR\x0erpcBeginTimeMs\x120\n\x07ext_map\x18\x17\x20\x03(\x0b2\
    \x17.PacketHead.ExtMapEntryR\x06extMap\x12\"\n\rsender_app_id\x18\x18\
    \x20\x01(\rR\x0bsenderAppId\x12\x1f\n\x0bsender_load\x18\x19\x20\x01(\rR\
    \nsenderLoad\x12(\n\x10span_context_str\x18\x1a\x20\x01(\x0cR\x0espanCon\
    textStr\x12%\n\x0esource_service\x18\x1f\x20\x01(\rR\rsourceService\x12%\
    \n\x0etarget_service\x18\x20\x20\x01(\rR\rtargetService\x12M\n\x12servic\
    e_app_id_map\x18!\x20\x03(\x0b2\x20.PacketHead.ServiceAppIdMapEntryR\x0f\
    serviceAppIdMap\x12+\n\x12is_set_game_thread\x18\"\x20\x01(\x08R\x0fisSe\
    tGameThread\x12*\n\x11game_thread_index\x18#\x20\x01(\rR\x0fgameThreadIn\
    dex\x1a9\n\x0bExtMapEntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\
    \x12\x14\n\x05value\x18\x02\x20\x01(\rR\x05value:\x028\x01\x1aB\n\x14Ser\
    viceAppIdMapEntry\x12\x10\n\x03key\x18\x01\x20\x01(\rR\x03key\x12\x14\n\
