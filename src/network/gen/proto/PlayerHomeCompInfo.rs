...
impl ::protobuf::Message for PlayerHomeCompInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.friend_enter_home_option != ::protobuf::EnumOrUnknown::new(super::FriendEnterHomeOption::FriendEnterHomeOption::FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM) {
            my_size += ::protobuf::rt::int32_size(8, self.friend_enter_home_option.value());
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(10, &self.seen_module_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(11, &self.unlocked_module_id_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(12, &self.levelup_reward_got_level_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.friend_enter_home_option != ::protobuf::EnumOrUnknown::new(super::FriendEnterHomeOption::FriendEnterHomeOption::FRIEND_ENTER_HOME_OPTION_NEED_CONFIRM) {
            os.write_enum(8, ::protobuf::EnumOrUnknown::value(&self.friend_enter_home_option))?;
        }
        os.write_repeated_packed_uint32(10, &self.seen_module_id_list)?;
        os.write_repeated_packed_uint32(11, &self.unlocked_module_id_list)?;
        os.write_repeated_packed_uint32(12, &self.levelup_reward_got_level_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \x02\n\x12PlayerHomeCompInfo\x12O\n\x18friend_enter_home_option\x18\x08\
    \x20\x01(\x0e2\x16.FriendEnterHomeOptionR\x15friendEnterHomeOption\x12-\
    \n\x13seen_module_id_list\x18\n\x20\x03(\rR\x10seenModuleIdList\x125\n\
    \x17unlocked_module_id_list\x18\x0b\x20\x03(\rR\x14unlockedModuleIdList\
    \x12@\n\x1dlevelup_reward_got_level_list\x18\x0c\x20\x03(\rR\x19levelupR\
    ewardGotLevelListB\x1b\n\x19emu.grasscutter.net.protob\x06proto3\
";
