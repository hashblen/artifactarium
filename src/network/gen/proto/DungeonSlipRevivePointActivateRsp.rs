...
impl ::protobuf::Message for DungeonSlipRevivePointActivateRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.slip_revive_point_id != 0 {
            my_size += ::protobuf::rt::uint32_size(15, self.slip_revive_point_id);
        }
        if self.retcode != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.slip_revive_point_id != 0 {
            os.write_uint32(15, self.slip_revive_point_id)?;
        }
        if self.retcode != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    tivateRsp\x12/\n\x14slip_revive_point_id\x18\x0f\x20\x01(\rR\x11slipRevi\
