...
impl ::protobuf::Message for ChangeAvatarRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.cur_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(6, self.cur_guid);
        }
        if self.skill_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        if self.cur_guid != 0 {
            os.write_uint64(6, self.cur_guid)?;
        }
        if self.skill_id != 0 {
...
static file_descriptor_proto_data: &'static [u8] = b"\
    \n\x15ChangeAvatarRsp.proto\"a\n\x0fChangeAvatarRsp\x12\x18\n\x07retcode\
    \x18\x03\x20\x01(\x05R\x07retcode\x12\x19\n\x08cur_guid\x18\x06\x20\x01(\
    \x04R\x07curGuid\x12\x19\n\x08skill_id\x18\x08\x20\x01(\rR\x07skillIdB\
