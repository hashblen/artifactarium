...
impl ::protobuf::Message for ReliquaryUpgradeRsp {
    ...
    fn compute_size(&self) -> u64 {
        ...
        if self.target_reliquary_guid != 0 {
            my_size += ::protobuf::rt::uint64_size(12, self.target_reliquary_guid);
        }
        if self.retcode != 0 {
            my_size += ::protobuf::rt::int32_size(5, self.retcode);
        }
        if self.power_up_rate != 0 {
            my_size += ::protobuf::rt::uint32_size(11, self.power_up_rate);
        }
        if self.cur_level != 0 {
            my_size += ::protobuf::rt::uint32_size(7, self.cur_level);
        }
        if self.old_level != 0 {
            my_size += ::protobuf::rt::uint32_size(14, self.old_level);
        }
        my_size += ::protobuf::rt::vec_packed_uint32_size(1, &self.cur_append_prop_list);
        my_size += ::protobuf::rt::vec_packed_uint32_size(8, &self.old_append_prop_list);
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        if self.target_reliquary_guid != 0 {
            os.write_uint64(12, self.target_reliquary_guid)?;
        }
        if self.retcode != 0 {
            os.write_int32(5, self.retcode)?;
        }
        if self.power_up_rate != 0 {
            os.write_uint32(11, self.power_up_rate)?;
        }
        if self.cur_level != 0 {
            os.write_uint32(7, self.cur_level)?;
        }
        if self.old_level != 0 {
            os.write_uint32(14, self.old_level)?;
        }
        os.write_repeated_packed_uint32(1, &self.cur_append_prop_list)?;
        os.write_repeated_packed_uint32(8, &self.old_append_prop_list)?;
...
static file_descriptor_proto_data: &'static [u8] = b"\
    ...
    \n\x15target_reliquary_guid\x18\x0c\x20\x01(\x04R\x13targetReliquaryGuid\
    \x12\x18\n\x07retcode\x18\x05\x20\x01(\x05R\x07retcode\x12\"\n\rpower_up\
    _rate\x18\x0b\x20\x01(\rR\x0bpowerUpRate\x12\x1b\n\tcur_level\x18\x07\
    \x20\x01(\rR\x08curLevel\x12\x1b\n\told_level\x18\x0e\x20\x01(\rR\x08old\
    Level\x12/\n\x14cur_append_prop_list\x18\x01\x20\x03(\rR\x11curAppendPro\
    pList\x12/\n\x14old_append_prop_list\x18\x08\x20\x03(\rR\x11oldAppendPro\
