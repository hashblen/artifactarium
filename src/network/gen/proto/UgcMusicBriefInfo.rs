...
impl ::protobuf::Message for UgcMusicBriefInfo {
    ...
    fn compute_size(&self) -> u64 {
        ...
        my_size += ::protobuf::rt::vec_packed_uint32_size(1365, &self.HEGNHLBBGFL);
        my_size += ::protobuf::rt::vec_packed_uint32_size(865, &self.GCLLDEFJCPH);
        if self.music_id != 0 {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream<'_>) -> ::protobuf::Result<()> {
        ...
        os.write_repeated_packed_uint32(1365, &self.HEGNHLBBGFL)?;
        os.write_repeated_packed_uint32(865, &self.GCLLDEFJCPH)?;
        if self.music_id != 0 {
